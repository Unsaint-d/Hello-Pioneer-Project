    ...
    while True:
        try:
            ...
            if (last_processed_frame is not None and 
                ...
                frame_count - last_frame_count < config.get('min_interval_frames', 3)):
            ...
            if not skip_processing:
                ...
                if frame_count % processing_interval == 0:
                    try:
                        ...
                        # Scale factor 0.25 means processing 1/16th of pixels
                        scale_factor = 0.25 
                        ...
                        face_locations_small = face_recognition.face_locations(rgb_small_frame, model=model_type)
...
class FaceRecognizer:
    ...
    def start_process(self) -> None:
        config = {
            ...
            'min_interval_frames': FACE_RECOGNITION_CONFIG.get('min_interval_frames', 3)
        }
